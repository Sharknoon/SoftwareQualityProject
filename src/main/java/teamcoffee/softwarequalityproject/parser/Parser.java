...
public class Parser {
    ...
    public static Result parse(String parse) {
        ...
        while (zähler != split.length) {

            String splitPart = split[zähler];
